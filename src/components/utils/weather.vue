                ...
                <div class="md:w-2/3 w-full grid grid-cols-3 md:grid-cols-2">
                    ...
                    <div class="flex items-start p-1 rounded-lg shadow-xs w-full">
                        ...
                        <p class="text-xs font-medium text-mayaYellow">
                            {{ClientDefaultWeather.feels_like}}
                        </p>
                        </div>
                    ...
                    <div class="flex items-start p-1 rounded-lg shadow-xs w-full">
                        ...
                        <p class="text-xs font-medium text-mayaYellow">
                            {{ClientDefaultWeather.visibility +" m"}}
                        </p>
                        </div>
                        <div class="mr-4 text-white">
                        <svg  class="w-6 h-6" fill="currentColor"  viewBox="0 0 30 30">
                    ...
                    <div class="flex items-start p-1 rounded-lg shadow-xs w-full">
                        ...
                        <p class="text-xs font-medium text-mayaYellow">
                            {{ClientDefaultWeather.wind_speed +" m/s"}}
                        </p>
                        </div>
                        <div class="mr-4 text-white">
                        <svg  class="w-6 h-6" fill="currentColor"  viewBox="0 0 30 30">
                    ...
                    <div class="flex items-start p-1 rounded-lg shadow-xs w-full">
                        ...
                        <p class="text-xs font-medium text-mayaYellow">
                            {{ClientDefaultWeather.pressure +" hPa"}}
                        </p>
                        </div>
                        <div class="mr-4 text-white">
                        <svg  class="w-6 h-6" fill="currentColor"  viewBox="0 0 30 30">
...
export default defineComponent({
  props: {
    ClientDefaultWeather:{
        type: Object as PropType<ClientDefaultWeather>,
        required: true
    }
  },
  mounted() {
    this.ClientDefaultWeather
  }
})
</script>
